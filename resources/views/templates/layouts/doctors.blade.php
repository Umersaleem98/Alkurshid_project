                  ...
                  <div class="team-member">
                      <div class="member-img">
                          @if($doctor->profile_picture)
                              <img src="{{ asset('uploads/profile_pictures/' . $doctor->profile_picture) }}" class="img-fluid" alt="{{ $doctor->name }}" style="height: 300px">
                          @else
                              <img src="{{ asset('templates/assets/img/doctors/default.jpg') }}" class="img-fluid" alt="Default" style="height: 300px">
                          @endif
                          <div class="social">
                              @if($doctor->twitter)
